...
const ReadQueryStr = `
query readShortRequestById($id: UUID!) {
  readShortRequestById: requestById(id: $id) {
...
const ReadQuery = createQueryStrLazy(`${ReadQueryStr}`, MediumFragment)
...
export const ReadShortRequestAsyncAction = createAsyncGraphQLAction2(ReadQuery)
ReadShortRequestAsyncAction.ename = "ReadShortRequestAsyncAction"