...
import { SemesterGQLModelTemplateRouterSegments } from "../../../packages/semester_majda/src/SemestrGQLModel/Pages/RouterSegment";
...
const Routes = [
    {
        ...
        element: <AppLayout />,
        children: [
            ...SemesterGQLModelTemplateRouterSegments, 
            ...BaseRouterSegments,
            // ...GroupRouterSegments,
